...
def generate_discovery_document(
    ...
    base_dir = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))) # draft_gtmos folder
    filename = f"discovery_{strategy_id}.md"
    
    # Save in draft_gtmos folder
    ...
    # Save in gtmos_test folder
    workspace_root = os.path.dirname(base_dir) # gtmos_test folder
